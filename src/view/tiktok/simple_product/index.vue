      ...
      <el-form class="table-form" ref="elForm" :model="searchInfo" size="mini" label-width="100px"
        ...
        <el-row :gutter="5">
          ...
          <template v-if="canUpload">
            <el-col :xs="6" :sm="6" :lg="3">
              <el-form-item label-width="0">
                <el-select v-model="searchInfo.has_upload" placeholder="是否有上架过" clearable style="width: 100%">
                  <el-option value=""></el-option>
                  <el-option label="未上架" value="2"></el-option>
                  <el-option label="有上架过" value="1"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :xs="6" :sm="6" :lg="3">
...
<!--            </el-col>-->
          ...
          <el-col :xs="6" :sm="6" :lg="3" v-if="canUpload">
            <el-form-item label-width="0">
        ...
        <el-table-column label="操作" align="center" width="200px">
          <template slot-scope="{row}">
            <el-row :gutter="5">
              ...
              <el-col :span="12" v-if="canUpload">
                <el-button style="width: 100%; margin-top: 5px" size="mini" type="primary" @click="hide(row)" v-if="row.user_images.is_hide">显示</el-button>
                <el-button style="width: 100%; margin-top: 5px" size="mini" type="primary" @click="hide(row)" v-else>隐藏</el-button>
              </el-col>
              <el-col :span="12">
                <el-button style="width: 100%; margin-top: 5px" size="mini" type="primary" @click="copyImages(row)">复制图片</el-button>
              </el-col>
              <el-col :span="12" v-if="canUpload && !row.user_images.reviewer">
                <el-button style="width: 100%; margin-top: 5px" size="mini" type="danger" @click="reviewOk([row])">产品过审</el-button>
              </el-col>
              <el-col :span="12">
                <el-button style="width: 100%; margin-top: 5px" type="primary" size="mini" @click="downloadImageBatch(row.user_images.images, row.name)">批量下载</el-button>
              </el-col>
            </el-row>
          </template>
        </el-table-column>
    ...
    <TiktokDlgSimpleProductUpload :list="uploadDlg.array" :visible="uploadDlg.visible" @close="uploadDlg.visible=false" @suc="getTableData"></TiktokDlgSimpleProductUpload>
    <TiktokDlgSimpleProductUploads :account-options="accountOptions" :product_ids="allUploadDlg.product_ids" :obj="allUploadDlg.obj" :visible="allUploadDlg.visible" @close="allUploadDlg.visible=false" @suc="getTableData"></TiktokDlgSimpleProductUploads>
    <TiktokDlgSimpleProductUploadRecords :account-options="accountOptions" :product_ids="uploadRecordDlg.product_ids" :obj="uploadRecordDlg.obj" :visible="uploadRecordDlg.visible" @close="uploadRecordDlg.visible=false" @suc="getTableData"></TiktokDlgSimpleProductUploadRecords>
...
import TiktokDlgSimpleProductUpload from "@/view/tiktok/simple_product/dlg_upload.vue";
import TemuDlgSimpleProductAddTags from "@/view/temu/simple_product/dlg_add_tags.vue";
import TiktokDlgSimpleProductUploadRecords from "@/view/tiktok/simple_product/dlg_upload_records.vue";
...
import TiktokDlgSimpleProductUploads from "@/view/tiktok/simple_product/dlg_uploads.vue";

export default {
  name: 'TiktokSimpleProduct',
  components: {
    TiktokDlgSimpleProductUploads,
    TemuDlgSimpleProductAddTags,
    TiktokDlgSimpleProductUploadRecords,
    TiktokDlgSimpleProductUpload,
  },
  mixins: [infoList],
  computed:{
