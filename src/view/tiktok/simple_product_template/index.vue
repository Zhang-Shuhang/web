<template>
  <div>
    ...
    <TiktokDlgCreateTemplate :edit="dlgTemplate.edit" :copy="dlgTemplate.copy" :visible="dlgTemplate.visible" @close="dlgTemplate.visible=false" @suc="getTableData"></TiktokDlgCreateTemplate>
  </div>
...
import {simpleProductDeleteTemplate, simpleProductTemplateListByPage} from "@/api/tiktok/simple_product";
import TiktokDlgCreateTemplate from "@/view/tiktok/components/dlg_create_template.vue";

export default {
  components: {
    TiktokDlgCreateTemplate,
  },
  mixins: [infoList],
  computed:{
  },
