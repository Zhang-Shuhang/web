<template>
  <div>
    ...
    <TiktokDlgCreate :visible="create.visible" @close="create.visible=false" @update="onSubmit"></TiktokDlgCreate>
    <TiktokDlgEdit :id="edit.id" :visible="edit.visible" @close="edit.visible=false"></TiktokDlgEdit>
  </div>

</template>

<script>
import {accountList, accountDelete} from "@/api/tiktok/account";
import TiktokDlgCreate from "./components/dlg_create";
import TiktokDlgEdit from "./components/dlg_edit";
