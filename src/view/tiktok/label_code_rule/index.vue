<template>
  <div>
    <div class="search-term">
      ...
      <TikotkDlgLabelCodeRule :is_create="dlg_rule.is_create" :is_copy="dlg_rule.is_copy" :row="dlg_rule.row" :visible="dlg_rule.visible" @close="dlg_rule.visible = false" @update="getTableData"></TikotkDlgLabelCodeRule>
    </div>
  </div>
...
import {labelCodeRuleList, labelCodeRuleRemove} from "@/api/tiktok/label_code_rule";
import TikotkDlgLabelCodeRule from "@/view/tiktok/label_code_rule/dlg_rule.vue";

export default {
  components: {
    TikotkDlgLabelCodeRule,
    KdxImage
  },
  mixins: [infoList],
  watch: {
