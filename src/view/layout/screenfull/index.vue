<template>
    <div @click="click">
        ...
        <svg t="1590133227479" class="screenfull-svg" viewBox="0 0 1024 1024" version="1.1" width="20" height="20"
             ...
             v-if="isShow">
            <path id="svg_1"
                  d="m928.512,959.744a32,32 0 0 1 -32,-32l0,-256a32,32 0 0 1 64,0l0,256a32,32 0 0 1 -32,32z"/>
            <path id="svg_2"
        ...
        <svg t="1590133734869" class="screenfull-svg" viewBox="0 0 1024 1024" version="1.1"
            ...
            <path d="M352.064 639.744a32 32 0 0 1 32 32v256a32 32 0 0 1-64 0v-256a32 32 0 0 1 32-32z" fill=""
                  p-id="1867"></path>
            <path d="M366.656 657.216a32 32 0 0 1 0 45.248L118.72 950.4a32 32 0 0 1-45.248-45.248l247.936-247.936a31.936 31.936 0 0 1 45.248 0z"
                  fill=""
                  p-id="1868"></path>
            ...
            <path d="M671.616 384.512a32 32 0 0 1-32-32v-256a32 32 0 0 1 64 0v256a32 32 0 0 1-32 32z" fill=""
                  p-id="1870"></path>
            <path d="M657.088 367.104a32 32 0 0 1 0-45.248l247.936-247.936a32 32 0 0 1 45.248 45.248l-247.936 247.936a32 32 0 0 1-45.248 0z"
                  fill=""
                  p-id="1871"></path>
        </svg>
    </div>
