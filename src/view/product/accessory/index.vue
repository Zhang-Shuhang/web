<template>
  <div>
        ...
        <el-row :gutter="5">
          <el-col :xs="6" :sm="6" :lg="16">
            <el-form-item label-width="0">
              <el-input placeholder="配件" v-model="searchInfo.name" clearable filterable @keyup.enter.native="onSubmit">
              </el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="8" :sm="4" :lg="4">
            <el-button size="mini" type="primary" style="width: 100%" @click="onCreate">创建配件</el-button>
          </el-col>
        </el-row>
      </el-form>
    ...
    <TemuDlgAccessoryEdit :id="categoryEditDlg.id" :visible="categoryEditDlg.visible" @close="categoryEditDlg.visible=false" @update="getTableData"></TemuDlgAccessoryEdit>
  </div>
...
import {accessoryListByPage} from "@/api/product/accessory";
import TemuDlgAccessoryEdit from "@/view/product/components/dlg_accessory_edit.vue";

export default {
  components: {
    TemuDlgAccessoryEdit,
    KdxImage
  },
  mixins: [infoList],
  data() {
    return {
      listApi: accessoryListByPage,
