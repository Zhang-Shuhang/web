<template>
  <div>
    <div class="search-term">
      <el-form class="table-form" ref="elForm" :model="searchInfo" size="mini" label-width="100px"
        ...
        <el-row :gutter="5">
          ...
          <el-col :xs="8" :sm="4" :lg="4">
            <el-button size="mini" type="primary" style="width: 100%" @click="onCreate">创建原材料</el-button>
          </el-col>
        </el-row>
      </el-form>
    ...
    <TemuDlgMetaMaterialEdit :id="categoryEditDlg.id" :visible="categoryEditDlg.visible" @close="categoryEditDlg.visible=false" @update="getTableData"></TemuDlgMetaMaterialEdit>
  </div>
...
import {metaMaterialListByPage} from "@/api/product/meta_material";
import TemuDlgMetaMaterialEdit from "@/view/product/components/dlg_meta_material_edit.vue";

export default {
  components: {
    TemuDlgMetaMaterialEdit,
    KdxImage
  },
  mixins: [infoList],
  data() {
    return {
      listApi: metaMaterialListByPage,
