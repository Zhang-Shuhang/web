  ...
  <div>
    <div class="search-term">
        ...
        <el-row :gutter="5">
          <el-col :xs="6" :sm="6" :lg="16">
            <el-form-item label-width="0">
              <el-input placeholder="包装材料" v-model="searchInfo.name" clearable filterable @keyup.enter.native="onSubmit">
              </el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="8" :sm="4" :lg="4">
            <el-button size="mini" type="primary" style="width: 100%" @click="onCreate">创建包装材料</el-button>
          </el-col>
        </el-row>
      </el-form>
      ...
      <el-table class="table-body" ref="multipleTable" :data="tableData" border height="100%" @sort-change="sortChange"
        ...
        <el-table-column label="图片" align="center" sortable="custom">
          <div slot-scope="{row}">
            <KdxImage :src="row.image" width="150px" height="150px" v-if="row.image"></KdxImage>
          </div>
        </el-table-column>
    ...
    <TemuDlgPackageMaterialEdit :id="categoryEditDlg.id" :visible="categoryEditDlg.visible" @close="categoryEditDlg.visible=false" @update="getTableData"></TemuDlgPackageMaterialEdit>
  </div>
...
import {packageMaterialListByPage} from "@/api/product/package_material";
import TemuDlgPackageMaterialEdit from "@/view/product/components/dlg_package_material_edit.vue";

export default {
  components: {
    TemuDlgPackageMaterialEdit,
    KdxImage
  },
  mixins: [infoList],
  data() {
    return {
      listApi: packageMaterialListByPage,
