<template>
  <div>
        ...
        <el-row :gutter="5">
          <el-col :xs="6" :sm="6" :lg="16">
            <el-form-item label-width="0">
              <el-input placeholder="工艺名字" v-model="searchInfo.name" clearable filterable @keyup.enter.native="onSubmit">
              </el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="8" :sm="4" :lg="4">
            <el-button size="mini" type="primary" style="width: 100%" @click="onCreate">创建工艺</el-button>
          </el-col>
        </el-row>
      </el-form>
    ...
    <TemuDlgTechEdit :id="categoryEditDlg.id" :visible="categoryEditDlg.visible" @close="categoryEditDlg.visible=false" @update="getTableData"></TemuDlgTechEdit>
  </div>
...
import {techListByPage} from "@/api/product/tech";
import TemuDlgTechEdit from "@/view/product/components/dlg_tech_edit.vue";
