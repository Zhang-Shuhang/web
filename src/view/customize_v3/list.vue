  ...
  <div>
    <div class="search-term">
      ...
      <el-table class="table-body" ref="multipleTable" :data="tableData" border height="100%" @sort-change="sortChange"
        ...
        <el-table-column label="上次更新时间" prop="updated_at" align="center">
          <div slot-scope="{row}">
    ...
    <CustomizeDlgEditorV3 :id="dlgEditor.id" :copy_id="dlgEditor.copy_id" :visible="dlgEditor.visible" @close="dlgEditor.visible=false" @suc="getTableData"></CustomizeDlgEditorV3>
  </div>
