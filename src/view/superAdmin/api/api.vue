        ...
        <div class="search-term">
            <el-form class="table-form" :model="searchInfo">
                <el-row>
                    ...
                    <el-col :span="4">
                        <el-form-item>
                            <el-select clearable placeholder="请选择" v-model="searchInfo.method" style="width: 100%">
                                <el-option
                                        :key="item.value"
                    ...
                    <el-col :span="4">
                        <el-form-item>
                            <el-button @click="openDialog('addApi')" type="primary" style="width: 100%">新增api
                            </el-button>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
            <el-table class="table-body" :data="tableData" @sort-change="sortChange" border stripe height="100%"
                ...
                <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button @click="editApi(scope.row)" size="small" type="primary" icon="el-icon-edit">编辑
                        </el-button>
                        <el-button @click="deleteApi(scope.row)" size="small" type="danger" icon="el-icon-delete">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    ...
    import {createApi, deleteApi, getApiById, getApiList, updateApi} from '@/api/api'
