        ...
        <el-col :span="12">
          ...
          <el-form-item label="请扫码输入任务编号" prop="name">
            <el-input size="mini" ref="itemId" v-model="form.id" placeholder="请扫码输入任务编号" style="width: 100%"
              ...
              <el-select v-model="form.mode" style="width: 180px" slot="append" placeholder="请选择">
                <el-option label="单个打印" :value="0"></el-option>
                <el-option label="打印整个箱唛" :value="1"></el-option>
              </el-select>
            </el-input>
          </el-form-item>
...
import {factoryBatchItem} from "@/api/sf-factory-v2/batch";
...
export default {
  ...
  methods: {
    ...
    async print() {
      ...
      let resp = await factoryBatchItem({id: this.form.id, mode: this.form.mode})
      if (resp.code) {
        return
      }
