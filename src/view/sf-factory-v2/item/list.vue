<template>
  <div>
    <div class="search-term">
      <el-form class="table-form" ref="elForm" :model="searchInfo" size="mini" label-width="100px" label-position="right">
        <el-row :gutter="15">
          ...
          <el-col :span="8">
            <el-form-item label-width="0">
              <el-input placeholder="查询货号" ref="sku_codes" v-model="searchInfo.sku_codes" clearable filterable @keyup.enter.native="onSubmit">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
    ...
    <FV2DlgUploadBarcode :is_create="toUpload.is_create" :id="toUpload.id" :pdf_url="toUpload.pdf_url" :visible="toUpload.visible" @update="getTableData" @close="toUpload.visible=false"></FV2DlgUploadBarcode>
  </div>
...
import {factoryItemList} from "@/api/sf-factory-v2/item";
