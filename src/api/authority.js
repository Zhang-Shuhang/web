...
export const getAuthorityList = (data) => {
    return service({
        url: "/core/authority/getAuthorityList",
        method: 'post',
        data
    })
}
...
export const deleteAuthority = (data) => {
    return service({
        url: "/core/authority/deleteAuthority",
        method: 'post',
        data
    })
}
...
export const createAuthority = (data) => {
    return service({
        url: "/core/authority/createAuthority",
        method: 'post',
        data
    })
}
...
export const copyAuthority = (data) => {
    return service({
        url: "/core/authority/copyAuthority",
        method: 'post',
        data
    })
}
...
export const setDataAuthority = (data) => {
    return service({
        url: "/core/authority/setDataAuthority",
        method: 'post',
        data
    })
}
...
export const updateAuthority = (data) => {
    return service({
        url: "/core/authority/updateAuthority",
        method: 'put',
        data
    })
}