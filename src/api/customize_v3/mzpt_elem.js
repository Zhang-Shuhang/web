...
export const mzptElemList = (params) => {
    return service({
        url: "/customize_v3/mzpt_elem/list",
        method: 'get',
        params
    })
}
...
export const mzptElemListByPage = (params) => {
    return service({
        url: "/customize_v3/mzpt_elem/list_by_page",
        method: 'get',
        params
    })
}
...
export const mzptElemLoad = (params) => {
    return service({
        url: "/customize_v3/mzpt_elem/load",
        method: 'get',
        params
    })
}
...
export const mzptElemLoadList = (params) => {
    return service({
        url: "/customize_v3/mzpt_elem/load_list",
        method: 'get',
        params
    })
}
...
export const mzptElemUpdate = (data) => {
    return service({
        url: "/customize_v3/mzpt_elem/update",
        method: 'post',
        data
    })
}