...
export const deleteSysOperationRecord = (data) => {
    return service({
        url: "/core/sysOperationRecord/deleteSysOperationRecord",
        method: 'delete',
        data
    })
}
...
export const deleteSysOperationRecordByIds = (data) => {
    return service({
        url: "/core/sysOperationRecord/deleteSysOperationRecordByIds",
        method: 'delete',
        data
    })
}
...
export const getSysOperationRecordList = (params) => {
    return service({
        url: "/core/sysOperationRecord/getSysOperationRecordList",
        method: 'get',
        params
    })
}